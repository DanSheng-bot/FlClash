...
@useResult
$Res call({
 bool isInit, bool backBlock, PageLabel pageLabel, List<Package> packages, int sortNum, Size viewSize, double sideWidth, DelayMap delayMap, List<Group> groups, int checkIpNum, Brightness brightness, int? runTime, List<ExternalProvider> providers, String? localIp, FixedList<TrackerInfo> requests, int version, FixedList<Log> logs, FixedList<Traffic> traffics, Traffic totalTraffic, bool realTunEnable, bool loading, bool accessibilityServiceEnabled, SystemUiOverlayStyle systemUiOverlayStyle, CoreStatus coreStatus
});
...
as bool,accessibilityServiceEnabled: null == accessibilityServiceEnabled ? _self.accessibilityServiceEnabled : accessibilityServiceEnabled // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  bool accessibilityServiceEnabled;
...
@override
int get hashCode => Object.hashAll([runtimeType,isInit,backBlock,pageLabel,const DeepCollectionEquality().hash(_packages),sortNum,viewSize,sideWidth,const DeepCollectionEquality().hash(_delayMap),const DeepCollectionEquality().hash(_groups),checkIpNum,brightness,runTime,const DeepCollectionEquality().hash(_providers),localIp,requests,version,logs,traffics,totalTraffic,realTunEnable,loading,accessibilityServiceEnabled,systemUiOverlayStyle,coreStatus]);
